 ...
 * ****************************************
 */
package hw3.neuralnet;

import hw3.neuralnet.data.LabeledInstance;
import hw3.neuralnet.data.LabeledInstances;
import hw3.neuralnet.data.UnlabeledInstance;
import hw3.neuralnet.data.UnlabeledInstances;
import hw3.neuralnet.strategy.ActivationStrategy;
import hw3.neuralnet.strategy.LogisticActivationStrategy;
...
public class ANN {
    ...
    private static LabeledInstances trainData;
...
//    public static ActivationStrategy activation = new ReLUActivationStrategy();
     ...
     */
    public ANN(int numInputs, int numHidden, int numOutputs) throws FileNotFoundException {
        ...
        this.trainData = new LabeledInstances("./src/circTrain.csv",
                                              true, 2);
    ...
    public LabeledInstances getTrainData() {
        return trainData;
    }

    public static void importNewTrainData(String filename) throws FileNotFoundException {
        ANN.trainData = new LabeledInstances(filename, true, 2);
    }
